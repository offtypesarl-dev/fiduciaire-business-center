        ...
        <div className="max-w-2xl">
          ...
          >
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2.5 rounded-full bg-[#128C4B] px-6 py-3.5 text-sm font-semibold uppercase tracking-wide text-white transition-all hover:bg-[#0f7a41] hover:shadow-lg"
            >
