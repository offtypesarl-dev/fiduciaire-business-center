        ...
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          <div className="rounded-2xl border border-navy-100 bg-navy-50 p-8 shadow-sm">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                className="flex w-full items-center justify-center gap-2.5 rounded-full bg-[#128C4B] px-7 py-3.5 text-sm font-semibold uppercase tracking-wide text-white transition-all hover:bg-[#0f7a41] hover:shadow-lg"
              >
